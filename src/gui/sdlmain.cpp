...
void GFX_EndUpdate( const Bit16u *changedLines ) {
	...
	case SCREEN_OPENGL:
		...
		if (sdl.opengl.pixel_buffer_object) {
			...
			//printf("3\n");
			glTexSubImage2D(GL_TEXTURE_2D, 0, 0, 0,
					sdl.draw.width, sdl.draw.height, GL_RGBA,
					GL_UNSIGNED_INT_8_8_8_8_REV, 0);
			//dprintf("4\n");
			glBindBufferARB(GL_PIXEL_UNPACK_BUFFER_EXT, 0);
		...
		if (changedLines) {
			...
			#ifdef __REDRAW_FULL
			glTexSubImage2D(GL_TEXTURE_2D, 0, 0, 0,sdl.draw.width, sdl.draw.height, GL_BGRA_EXT,GL_UNSIGNED_INT_8_8_8_8_REV, sdl.opengl.framebuf );
			...
			while (y < sdl.draw.height) {
				if (!(index & 1)) {
					...
					//dprintf("5\n");
					//glTexSubImage2D(GL_TEXTURE_2D, 0, 0, y,sdl.draw.width, height, GL_AGBR,GL_UNSIGNED_INT_8_8_8_8_REV, pixels );
					//printf("6\n");
					glTexSubImage2D(GL_TEXTURE_2D, 0, 0, y,sdl.draw.width, height, GL_BGRA_EXT,GL_UNSIGNED_INT_8_8_8_8_REV, pixels );
